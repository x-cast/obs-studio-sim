				...
				size_t *size)
{
	...
	*enc++ = AMF_ECMA_ARRAY;
	...
	enc_bool_val(&enc, end, "3.0", audio_output_get_channels(audio) == 3);
	enc_bool_val(&enc, end, "4.0", audio_output_get_channels(audio) == 4);
	enc_bool_val(&enc, end, "quad", audio_output_get_channels(audio) == 4);
	enc_bool_val(&enc, end, "3.1", audio_output_get_channels(audio) == 4);
	enc_bool_val(&enc, end, "5.0", audio_output_get_channels(audio) == 5);
	enc_bool_val(&enc, end, "4.1", audio_output_get_channels(audio) == 5);
	enc_bool_val(&enc, end, "6.0", audio_output_get_channels(audio) == 6);
	enc_bool_val(&enc, end, "5.1", audio_output_get_channels(audio) == 6);
	enc_bool_val(&enc, end, "6.1", audio_output_get_channels(audio) == 7);
	enc_bool_val(&enc, end, "7.0", audio_output_get_channels(audio) == 7);
	...
	enc_bool_val(&enc, end, "9.0", audio_output_get_channels(audio) == 9);
	enc_bool_val(&enc, end, "10.0", audio_output_get_channels(audio) == 10);
	enc_bool_val(&enc, end, "11.0", audio_output_get_channels(audio) == 11);
	enc_bool_val(&enc, end, "12.0", audio_output_get_channels(audio) == 12);
	enc_bool_val(&enc, end, "13.0", audio_output_get_channels(audio) == 13);
