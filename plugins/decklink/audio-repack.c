		...
		audio_repack_mode_t repack_mode, uint8_t sample_bit)
{
	...
	int _audio_repack_ch[16] = { 3, 4, 5, 6, 5, 6, 7, 8, 8, 9, 10, 11, 12, 13, 14, 15 };
	...
	if (repack_mode == repack_mode_8to5ch_swap || repack_mode == repack_mode_8to6ch_swap || repack_mode == repack_mode_8ch_swap)
