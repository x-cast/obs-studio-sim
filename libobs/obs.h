...
EXPORT struct obs_audio_data *obs_source_output_audio_track(obs_source_t *source,
...
/** When dynamic bitrate is enabled, returns the status of bitrate (increasing, decreasing, stationary) */
EXPORT int obs_output_get_bitrate_state(obs_output_t *output);
