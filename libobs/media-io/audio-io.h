...
static inline uint32_t get_audio_channels(enum speaker_layout speakers)
{
	...
	case SPEAKERS_3POINT0:          return 3;
	case SPEAKERS_4POINT0:
	case SPEAKERS_QUAD:
	case SPEAKERS_3POINT1:          return 4;
	case SPEAKERS_5POINT0:
	case SPEAKERS_4POINT1:          return 5;
	case SPEAKERS_5POINT1:
	case SPEAKERS_6POINT0:          return 6;
	case SPEAKERS_6POINT1:
	case SPEAKERS_7POINT0:          return 7;
	case SPEAKERS_7POINT1:
	case SPEAKERS_OCTAGONAL:        return 8;
	case SPEAKERS_9POINT0:          return 9;
